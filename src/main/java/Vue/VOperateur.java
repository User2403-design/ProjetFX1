...
/**
 * Classe VOperateur représentant la vue pour la gestion des opérateurs
 * @author chloe
 */
public class VOperateur {
    ...
    /**
     * Constructeur de la vue VOperateur
     */
    public VOperateur() {
        Text titre = new Text("Section Opérateur");                 // Création d'un objet texte avec le titre
